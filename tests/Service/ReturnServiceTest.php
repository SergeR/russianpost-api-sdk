...
final class ReturnServiceTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $result = $this->client->returns()->create(['barcode' => '123456789']);

        self::assertIsArray($result);
    }

    public function testCreateWithoutDirect(): void
    {
        $this->mockClient->addResponse(
            $this->factory->createResponse(200)
                ->withHeader('Content-Type', 'application/json')
        ...
        $result = $this->client->returns()->createWithoutDirect(['barcode' => '123456789']);

        self::assertIsArray($result);
    }

    public function testDeleteSeparate(): void
    {
        $this->mockClient->addResponse(
            $this->factory->createResponse(200)
                ->withHeader('Content-Type', 'application/json')
        ...
        $result = $this->client->returns()->deleteSeparate('123456789');
